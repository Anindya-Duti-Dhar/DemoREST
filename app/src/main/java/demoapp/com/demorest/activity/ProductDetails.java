...
import demoapp.com.demorest.fragment.ProductDetailsFirstPart;
import demoapp.com.demorest.fragment.ProductDetailsSecondPart;

public class ProductDetails extends AppCompatActivity {

    private static final String TAG = ProductDetails.class.getSimpleName();
    String mParsedProductName;
    Button mAddToCartButton, mBuyButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate");
        setContentView(R.layout.rent_details);
