package demoapp.com.demorest.services;
...
import demoapp.com.demorest.utils.ChatPingAlarmManager;
    ...
    private void sendResultToActivity(boolean isSuccess, String errorMessage) {
        if (pendingIntent != null) {
            ...
            try {
                ...
                pendingIntent.send(SignUpService.this, Consts.EXTRA_LOGIN_RESULT_CODE, intent);
